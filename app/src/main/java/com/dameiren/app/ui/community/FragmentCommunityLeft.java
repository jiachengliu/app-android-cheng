...
/**
 * 作者:liujiacheng.
 * 日期: 2016/6/7 0007 18:20.
 * 描述：社区精选
 */
public class FragmentCommunityLeft  extends BaseFragment {
    private static final String TAG = FragmentCommunityLeft.class.getSimpleName();
