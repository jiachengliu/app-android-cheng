...
import com.litesuits.utils.JCFileUtils;
import com.litesuits.utils.JCSystemTool;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private void saveToSDCard(Throwable ex) throws Exception {
        File file = JCFileUtils.getSaveFile(AppConfig.crash,
                JCSystemTool.getDataTime("yyyy-MM-dd-HH-mm-ss")+".log");
        ...
        PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(
                file, append)));
        // 导出发生异常的时间
        pw.println(JCSystemTool.getDataTime("yyyy-MM-dd-HH-mm-ss"));
        // 导出手机信息
        dumpPhoneInfo(pw);
        pw.println();
        // 导出异常的调用栈信息
